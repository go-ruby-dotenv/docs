# go-ruby-dotenv documentation

**Pure-Go (CGO=0) MRI-faithful Ruby Dotenv .env parser**

`go-ruby-dotenv/dotenv` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `dotenv`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `dotenv`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`dotenv`](https://github.com/go-ruby-dotenv/dotenv) | the library — Ruby's `dotenv` in pure Go |
| [`docs`](https://github.com/go-ruby-dotenv/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-dotenv.github.io`](https://github.com/go-ruby-dotenv/go-ruby-dotenv.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-dotenv/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-dotenv/dotenv](https://github.com/go-ruby-dotenv/dotenv).
