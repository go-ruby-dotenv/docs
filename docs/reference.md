...
The public API lives at the module root (`github.com/go-ruby-dotenv/dotenv`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `dotenv`, while the surface follows
...
```go
import "github.com/go-ruby-dotenv/dotenv"
```
...
- **[pkg.go.dev/github.com/go-ruby-dotenv/dotenv](https://pkg.go.dev/github.com/go-ruby-dotenv/dotenv)**

The module's [README](https://github.com/go-ruby-dotenv/dotenv#readme) carries worked
